...
class EmployeeServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListAllEmployeesWithSameTitle = channel.unary_unary(
                '/employee_service.EmployeeService/ListAllEmployeesWithSameTitle',
                request_serializer=EmployeeService__pb2.EmployeeTitle.SerializeToString,
                response_deserializer=EmployeeService__pb2.EmployeeDataList.FromString,
                )
        self.GetEmployeeDataFromName = channel.unary_unary(
                '/employee_service.EmployeeService/GetEmployeeDataFromName',
                request_serializer=EmployeeService__pb2.EmployeeName.SerializeToString,
                response_deserializer=EmployeeService__pb2.EmployeeData.FromString,
                )
...
class EmployeeServiceServicer(object):
    ...
    def ListAllEmployeesWithSameTitle(self, request, context):
        """List all employees with the same title
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
    ...
    def GetEmployeeDataFromName(self, request, context):
        """Get an employee´s data from name
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_EmployeeServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ListAllEmployeesWithSameTitle': grpc.unary_unary_rpc_method_handler(
                    servicer.ListAllEmployeesWithSameTitle,
                    request_deserializer=EmployeeService__pb2.EmployeeTitle.FromString,
                    response_serializer=EmployeeService__pb2.EmployeeDataList.SerializeToString,
            ),
            'GetEmployeeDataFromName': grpc.unary_unary_rpc_method_handler(
                    servicer.GetEmployeeDataFromName,
                    request_deserializer=EmployeeService__pb2.EmployeeName.FromString,
                    response_serializer=EmployeeService__pb2.EmployeeData.SerializeToString,
            ),
    }
...
class EmployeeService(object):
    ...
    @staticmethod
    def ListAllEmployeesWithSameTitle(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/employee_service.EmployeeService/ListAllEmployeesWithSameTitle',
    ...
    @staticmethod
    def GetEmployeeDataFromName(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/employee_service.EmployeeService/GetEmployeeDataFromName',
            EmployeeService__pb2.EmployeeName.SerializeToString,
            EmployeeService__pb2.EmployeeData.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
